...
def main():
    # part c: diagonal neighborhood (nd)
    image_path = 'Clerigo_Grayscale.jpg'
    target_row = 150
    target_col = 150

    print(f"--- DIP Exercise 2 | Part C: Diagonal Neighborhood ---")
    ...
    for name, (dr, dc) in nd_coords.items():
    ...
    print("\nLegend: [ ] = Reference, * = Diagonal Neighbor")

    # save output image
    save_output_image(roi, nd_coords.values(), "Exer2_PartC_Output.png")
