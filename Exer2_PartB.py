...
def main():
    # part b: 8-neighborhood (n8) pixel relationship
    image_path = 'Clerigo_Grayscale.jpg'
    target_row = 150
    target_col = 150

    print(f"--- DIP Exercise 2 | Part B: N8 Neighborhood ---")
    ...
    print("N8 Neighbors:")
    for name, (dr, dc) in n8_coords.items():
    ...
    print("\nLegend: [ ] = Reference, * = N8 Neighbor")
    
    # save output image
    save_output_image(roi, n8_coords.values(), "Exer2_PartB_Output.png")
